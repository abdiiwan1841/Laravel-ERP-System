...
<div class="receipt">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="receipt-body">
        <tr>
            <td>
                <span><b>{{trans('applang.from')}}: </b> {{$payment->salesInvoice->client->full_name}}</span>
            </td>
        </tr>
        <tr>
            <td width="25%">
        ...
        <tr>
            <td colspan="5">
                <span ><b>{{trans('applang.sales_invoice_number')}}: </b>#{{$payment->salesInvoice->inv_number}}</span>
            </td>
        </tr>
        <tr>
            <td>
