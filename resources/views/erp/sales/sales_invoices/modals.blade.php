...
{{--                        <span id="payment_status" class="badge mr-1 ml-1"></span>--}}
                    ...
                    <div id="modal_buttons">
                        <a href="{{route('SalesInvoiceDownPaymentReceiptPrint', $salesInvoice->id)}}" target="_blank" class="btn btn-primary btn-sm d-inline-flex align-items-center">
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="bg-primary modal-header">
                            <h6 class="modal-title white">{{trans('applang.client_details')}}</h6>
                        </div>
                        <div class="card-body">
                            <table class="user-view table-responsive" style="width: 100%">
                                <tbody>
                                <tr>
                                    <th class="no-wrap" scope="row">{{trans('applang.client_name')}} :</th>
                                    <td class="w-25"></td>
                                    <td class="">{{$salesInvoice->client->full_name}}</td>
                                </tr>
                                <tr>
                                    <th class="no-wrap" scope="row">{{trans('applang.street_address')}} :</th>
                                    <td class="w-25"></td>
                                    <td class="">{{$salesInvoice->client->street_address ?? ''}}</td>
                                </tr>
                                <tr>
                                    <th class="no-wrap" scope="row">{{trans('applang.city')}} :</th>
                                    <td class="w-25"></td>
                                    <td class="">{{$salesInvoice->client->city ?? ''}}</td>
                                </tr>

                                <tr>
                                    <th class="no-wrap" scope="row">{{trans('applang.state')}} :</th>
                                    <td class="w-25"></td>
                                    <td class="">{{$salesInvoice->client->state ?? ''}}</td>
                                </tr>

                                <tr>
                                    <th class="no-wrap" scope="row">{{trans('applang.postal_code')}} :</th>
                                    <td class="w-25"></td>
                                    <td class="">{{$salesInvoice->client->postal_code ?? ''}}</td>
                                </tr>

                                <tr>
                                    <th class="no-wrap" scope="row">{{trans('applang.phone_number')}} :</th>
                                    <td class="w-25"></td>
                                    <td class="">{{$salesInvoice->client->phone ?? ''}}</td>
                                </tr>

                                <tr>
                                    <th class="no-wrap" scope="row">{{trans('applang.country')}} :</th>
                                    <td class="w-25"></td>
                                    <td class="w-100">{{$salesInvoice->client->country ?? ''}}</td>
                                </tr>

                                <tr>
                                    <th class="no-wrap" scope="row">{{trans('applang.currency')}} :</th>
                                    <td class="w-25"></td>
                                    <td class="w-100">{{$salesInvoice->client->currency ?? ''}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="user-view table-responsive" style="width: 100%">
                                <tbody>
                                <tr>
                                    <th class="no-wrap" scope="row">{{trans('applang.sales_invoice_number')}} :</th>
                                    <td class="w-25"></td>
                                    <td class="">{{$salesInvoice->inv_number}}</td>
                                </tr>
                                <tr>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-instagram bg-lighten-4">
                    ...
                    <div id="modal_buttons">
                        <a href="{{route('SalesInvoicePaymentReceiptPrint', 'test')}}" target="_blank" class="btn btn-primary btn-sm d-inline-flex align-items-center print-receipt-ajax">
                            <i class="bx bx-printer"></i>
                            <span style="margin-right: 3px; margin-left: 3px">{{trans('applang.receipt')}}</span>
                        </a>
                        <a href=""
    ...
    <div class="modal fade text-left" id="formModalEditPayment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('SalesInvoiceUpdatePaymentTransaction')}}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="form-row">
                            <input type="hidden" value="{{$salesInvoice->id}}" name="sales_invoice_id">
