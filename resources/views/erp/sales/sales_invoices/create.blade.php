...
@section('title', trans('applang.add_sales_invoice'))
    ...
    <div class="container-fluid">
        <div class="content-body">
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <form action="{{route('sales-invoices.store')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        @livewire('erp.sales.sales-invoices.create-sales-invoice')
                    </form>
                </div>
            </div>
        </div>
