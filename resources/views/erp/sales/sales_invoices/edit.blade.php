...
@section('title', trans('applang.edit_sales_invoice'))
    ...
    <div class="container-fluid">
        <div class="content-body">
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <form action="{{route('sales-invoices.update', $salesInvoice->id)}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        @method('PATCH')
                        @livewire('erp.sales.sales-invoices.edit-sales-invoice', ['salesInvoice' => $salesInvoice])
                    </form>
                </div>
            </div>
        </div>
