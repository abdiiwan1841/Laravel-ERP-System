...
@section('title', trans('applang.branch_add'))
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header modal-header bg-primary">
                        <h4 class="modal-title white">{{trans('applang.branch_add')}}</h4>
                    </div>
                    <div class="card-body mt-1" style="padding-bottom: 13px">
                        <form action="{{route('branches.store')}}" method="POST">
                            @csrf

                            @livewire('erp.create-branch-translation')

                            @if(request()->is(app()->getLocale().'/erp/branches/create/translated/*'))
