...
@section('title', trans('applang.edit_supplier'))
                ...
                <form action="{{route('suppliers.update', $supplier)}}" method="POST">
                    ...
                    <div class="card">
                        <div class="card-header modal-header bg-primary">
                            <h4 class="modal-title white">{{trans('applang.edit_supplier')}}</h4>
                        </div>
                                        ...
                                        <div class="card-body mt-1">
                                            ...
                                            <div class="position-relative has-icon-left mb-50">
                                                <input id="commercial_name"
                                                       ...
                                                       value="{{$supplier->commercial_name ?? old('commercial_name')}}"
                                                       autofocus>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input id="first_name"
                                                               ...
                                                               value="{{$supplier->first_name ?? old('first_name')}}"
                                                               autofocus>
                                                        <div class="form-control-position">
                                                            <i class="bx bx-pen"></i>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input id="last_name"
                                                               ...
                                                               value="{{$supplier->last_name ?? old('last_name')}}"
                                                        >
                                                        <div class="form-control-position">
                                                            <i class="bx bx-pen"></i>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input id="state"
                                                               ...
                                                               autocomplete="state"
                                                               value="{{$supplier->state ?? old('state')}}"
                                                               autofocus>
                                                        <div class="form-control-position">
                                                            <i class="bx bx-pen"></i>
                                                        </div>
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input id="street_address"
                                                               ...
                                                               value="{{$supplier->street_address ?? old('street_address')}}"
                                                               autofocus>
                                                        <div class="form-control-position">
                                                            <i class="bx bx-pen"></i>
                                                        </div>
                                                    ...
                                                    <div class="input-group" dir="ltr">
                                                        <div class="input-group-append" style="width: 20%">
                                                            <input type="text" class="form-control text-append-phone-code phone_code text-center" readonly name="phone_code"
                                                                   placeholder="&#9872; &#9743;" value="{{$supplier->phone_code ?? old('phone_code')}}">
                                                        </div>
                                                        <input id="phone"
                                                               type="number"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group" dir="ltr">
                                                        ...
                                                        <input id="mobile"
                                                               ...
                                                               autocomplete="mobile"
                                                               value="{{$supplier->mobile ?? old('mobile')}}"
                                                               autofocus>
                                                        @error('mobile')
                                                        <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input id="commercial_record"
                                                               ...
                                                               value="{{$supplier->commercial_record ?? old('commercial_record')}}"
                                                               autofocus>
                                                        <div class="form-control-position">
                                                            <i class="bx bx-pen"></i>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input id="tax_registration"
                                                               ...
                                                               value="{{$supplier->tax_registration ?? old('tax_registration')}}"
                                                               autofocus>
                                                        <div class="form-control-position">
                                                            <i class="bx bx-pen"></i>
                                                        </div>
                                            ...
                                            <div id="supplier_contacts" class="mt-2">
                                                <h3  class="font-medium-4 font-weight-bolder hidden supplier_contacts_head">{{trans('applang.contact_list')}}</h3>
                                                    ...
                                                    @foreach($supplier->contacts as $index => $contact)
                                                        ...
                                                        <div class="supplier_contact_row">
                                                            <a class="btn btn-danger btn-xs remove-contact"
                                                               ...
                                                               data-name="{{$contact->supp_cont_first_name}} {{$contact->supp_cont_last_name}}"
                                                               href="#">
                                                                <i class="bx bx-x"></i>
                                                            </a>
                                                            <div class="row">
                                                                <div class="col-md-6 col-xs-12 form-group">
                                                                    ...
                                                                    <input name="supp_cont_first_name[]" type="text" value="{{$contact->supp_cont_first_name}}" class="form-control @error('supp_cont_first_name.'.$index) is-invalid @enderror" id="supp_cont_first_name">
                                                                    @error('supp_cont_first_name.'.$index)
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                                    @enderror
                                                                ...
                                                                <div class="col-md-6 col-xs-12 form-group">
                                                                    ...
                                                                    <input name="supp_cont_last_name[]" type="text" value="{{$contact->supp_cont_last_name}}" class="form-control @error('supp_cont_last_name.'.$index) is-invalid @enderror" id="supp_cont_last_name">
                                                                    @error('supp_cont_last_name.'.$index)
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                                    @enderror
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input name="supp_cont_email[]" type="email" value="{{$contact->supp_cont_email}}" class="form-control @error('supp_cont_email.'.$index) is-invalid @enderror" id="supp_cont_email">
                                                                @error('supp_cont_email.'.$index)
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                                @enderror
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 col-xs-12 form-group">
                                                                    ...
                                                                    <input name="supp_cont_phone[]" type="number" value="{{$contact->supp_cont_phone}}" class="form-control @error('supp_cont_phone.'.$index) is-invalid @enderror" id="supp_cont_phone">
                                                                    @error('supp_cont_phone.'.$index)
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                                    @enderror
                                                                ...
                                                                <div class="col-md-6 col-xs-12 form-group">
                                                                    ...
                                                                    <input name="supp_cont_mobile[]" type="number" value="{{$contact->supp_cont_mobile}}" class="form-control @error('supp_cont_mobile.'.$index) is-invalid @enderror" id="supp_cont_mobile">
                                                                    @error('supp_cont_mobile.'.$index)
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                                    @enderror
                                        ...
                                        <div class="card-body mt-1">
                                            ...
                                            <fieldset class="form-group mb-50">
                                                <select id="status" class="custom-select @error('status') is-invalid @enderror" name='status'>
                                                    ...
                                                    <option value="0" {{$supplier->status == 0 ? 'selected' : ''}}>{{trans('applang.suspended')}}</option>
                                                    <option value="1" {{$supplier->status == 1 ? 'selected' : ''}}>{{trans('applang.active')}}</option>
                                                </select>
                                                ...
                                                <div class="input-group-append">
                                                    <select id="currency" class="custom-select @error('currency') is-invalid @enderror text-append-currency" name='currency'>
                                                        ...
                                                        @foreach($currencies as $key => $value)
                                                            <option value="{{$key}}" {{$supplier->currency == $key ? 'selected' : ''}}>{{$value['name']}}</option>
                                                        @endforeach
                                                    </select>
                                                    <input type="text" class="form-control text-append-currency-symbol basic-currency-symbol text-center" readonly name="currency_symbol"
                                                           placeholder="{{trans('applang.symbol')}}" value="{{$supplier->currency_symbol ?? old('currency_symbol')}}" style="width:20%">
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text"
                                                               ...
                                                               value="{{$supplier->opening_balance_date}}"
                                                        >
                                                        <div class="form-control-position">
