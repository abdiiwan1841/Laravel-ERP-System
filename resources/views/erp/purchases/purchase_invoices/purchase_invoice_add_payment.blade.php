                    ...
                    <div class="card">
                        <div class="card-header modal-header bg-primary justify-content-start">
                            <h4 class="modal-title white">
                                {{trans('applang.add_payment_transaction').' '.trans('applang.purchase_invoice') . ' # (' . $purchaseInvoice->inv_number . ')'}}
                            </h4>
                        </div>

                        <div class="card-body mt-1" style="padding-bottom: 13px">
                            <form action="{{route('storePaymentTransaction')}}" method="POST">
                                @csrf
                                <div class="form-row">
                                    <input type="hidden" value="{{$purchaseInvoice->id}}" name="purchaseInvoice_id">
                                    <div class="col-md-6">
