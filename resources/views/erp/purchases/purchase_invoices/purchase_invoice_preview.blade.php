                            ...
                            <div class="invoice-subtotal w-75 print-w-75">
                                ...
                                @if($purchaseInvoice->payments_total > 0.00)
                                    <div class="invoice-calc d-flex justify-content-between">
                                        ...
                                        <span class="invoice-value pt-25 pb-25">-{{number_format($purchaseInvoice->payments_total,0,'.','')}} {{$companyData->basic_currency_symbol}}</span>
                                    </div>
                                    <hr class="inv-hr">
                                    <hr class="print-inv-hr" style="display: none">
                                    <div class="invoice-calc d-flex justify-content-between print-bg-gray" style="background-color: #D9D9D9">
                                        <span class="invoice-title pt-25 pb-25 text-bold-700">{{trans('applang.due_amount_after_payments')}}</span>
                                        <span class="invoice-value pt-25 pb-25">{{number_format($purchaseInvoice->due_amount_after_payments, 0, '.', '')}} {{$companyData->basic_currency_symbol}}</span>
                                    </div>
                                    <hr class="inv-hr">
                                @endif
                            </div>
