                ...
                <div class="card invoice-print-area mt-5 mb-5 black">
                    <div class="card-body pb-0 mx-25">
                        <div class="receipt mb-5 p-1 ">
                            ...
                            <div class="receipt-body">
                                <span class="font-small d-block"><b>{{trans('applang.to')}}: </b> {{$payment->purchaseInvoice->supplier->first_name}} {{$payment->purchaseInvoice->supplier->last_name}}</span>
                                <span class="d-block">
                                ...
                                <span class="font-small d-block"><b>{{trans('applang.purchase_invoice_number')}}: </b>#{{$payment->purchaseInvoice->inv_number}}</span>
                    ...
                    <div class="card-footer d-flex d-print-none {{app()->getLocale() == 'ar' ? 'justify-content-end' : 'justify-content-start'}}" style="font-family: 'Nunito', sans-serif !important">
                        @if(app()->getLocale() == 'ar')
                            ...
                            <a href="{{route('paymentReceiptPdf', $payment->id)}}" target="_blank" class="btn btn-instagram ml-50 mr-50"><i class="bx bxs-file-pdf"></i> PDF</a>
