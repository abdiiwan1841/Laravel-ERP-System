...
@section('title', trans('applang.add_purchase_invoice'))
    ...
    <div class="container-fluid">
        <div class="content-body">
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <form action="{{route('purchase-invoices.store')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        @livewire('erp.purchases.create-purchase-invoice')
                    </form>
                </div>
            </div>
        </div>
