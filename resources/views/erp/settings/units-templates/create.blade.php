...
@section('title', trans('applang.add_new_template'))
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header modal-header bg-primary">
                        <h4 class="modal-title white">{{trans('applang.add_new_template')}}</h4>
                    </div>
                    <div class="card-body mt-1" style="padding-bottom: 13px">
                        <form action="{{route('units-templates.store')}}" method="POST">
                            @csrf
