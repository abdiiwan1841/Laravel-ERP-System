...
@section('title', trans('applang.seq_code_add'))
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header modal-header bg-primary">
                        <h4 class="modal-title white">{{trans('applang.seq_code_add')}}</h4>
                    </div>
                    <div class="card-body mt-1" style="padding-bottom: 13px">
                        <form action="{{route('sequential-codes.store')}}" method="POST">
                            @csrf
