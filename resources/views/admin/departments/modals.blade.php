@if (Spatie\Permission\Models\Permission::count() > 0)
    <!--Start Delete Modal -->
    <div class="modal fade text-left" id="formModalDeletePermissionCategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('perm_categories.destroy', $category)}}" method="POST">
                        @csrf
                        @method('Delete')
