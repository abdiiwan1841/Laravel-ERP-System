...
@section('title', trans('applang.create_permission'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header modal-header bg-primary">
                    <h4 class="modal-title white">{{trans('applang.create_permission')}}</h4>
                </div>
                <div class="card-body mt-1" style="padding-bottom: 13px">
                    <form action="{{route('permissions.store')}}" method="POST">
                        @csrf

                        @livewire('admin.permission-translation')

                        @if(request()->is(app()->getLocale().'/admin/permissions/create/translated/*'))
                            ...
                            <div class="form-group col-md-12 mb-50">
                                ...
                                <div class="position-relative has-icon-left">
                                    ...
                                    @if ($errors->has('category'))
                                        <small><strong class="text-danger">{{ $errors->first('category') }}</strong></small>
                                    @endif
                                </div>
                            </div>
                        @endif
