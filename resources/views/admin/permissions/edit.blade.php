...
@section('title', trans('applang.edit_permission'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header modal-header bg-primary">
                    <h4 class="modal-title white">{{trans('applang.edit_permission')}}</h4>
                </div>
                <div class="card-body mt-1" style="padding-bottom: 13px">
                    <form action="{{route('permissions.update', $transPermission->permission_id)}}" method="POST">
                        @csrf
                        @method('PATCH')

                        @livewire('admin.permission-edit-translation')
                        ...
                        <div class="form-group col-md-12 mb-50">
                            ...
                            <div class="position-relative has-icon-left">
                                <input id="name_ar"
                                        ...
                                        value="{{isset($translated_ar) ? $translated_ar : $transPermission->name_ar}}"
                                        autofocus>
                        ...
                        <div class="form-group col-md-12 mb-50">
                            ...
                            <div class="position-relative has-icon-left">
                                <input id="name_en"
                                        ...
                                        value="{{isset($translated_en) ? $translated_en : $transPermission->name_en}}"
                                        autofocus>
                                <div class="form-control-position">
                                    <i class="bx bxs-lock"></i>
                                </div>
                        ...
                        <div class="form-group col-md-12 mb-50">
                            <label class="required" for="category">{{ trans('applang.category') }}</label>
                            <div class="position-relative has-icon-left">
                                <select class="custom-select" name="category" id="category">
                                    <option value="0" selected disabled>{{trans('applang.select_perm_cat')}}</option>
                                    @foreach ($categories as $cat)
                                        <option value="{{$cat->id}}" {{$transPermission->category_id == $cat->id ? 'selected' : ''}}>
