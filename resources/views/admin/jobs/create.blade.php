...
@section('title', trans('applang.create_job'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header modal-header bg-primary">
                    <h4 class="modal-title white">{{trans('applang.create_job')}}</h4>
                </div>
                <div class="card-body mt-1" style="padding-bottom: 13px">
                    <form action="{{route('jobs.store')}}" method="POST">
                        @csrf

                        @livewire('admin.job-translation')

                        @if(request()->is(app()->getLocale().'/admin/jobs/create/translated/*'))
