...
@section('title', trans('applang.jobs'))
        ...
        <div class="default-app-list-table">
            <div class="card">
                <div class="card-header justify-content-start">
                    <a href="{{route('jobs.create')}}" class="btn btn-success mb-0">
                                        ...
                                        <tr id="selected_row_{{$job->id}}">
                                            ...
                                            <td class="normal-wrap">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-toggle="modal"
                                                    data-target="#formModalDeleteJob"
                                                    data-job_id="{{$job->id}}"
                                                    data-name_ar="{{$job->name_ar}}"
                                                    data-name_en="{{$job->name_en}}"
                                                    >
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#formModalDeleteJob').on('show.bs.modal', function (event) {
