...
@section('title', trans('applang.edit_job'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header modal-header bg-primary">
                    <h4 class="modal-title white">{{trans('applang.edit_job')}}</h4>
                </div>
                <div class="card-body mt-1" style="padding-bottom: 13px">
                    <form action="{{route('jobs.update', $job)}}" method="POST">
                        ...
                        @livewire('admin.job-edit-translation')
                        ...
                        <div class="form-group col-md-12 mb-50">
                            ...
                            <div class="position-relative has-icon-left">
                                <input id="name_ar"
                                        ...
                                        value="{{isset($translated_ar) ? $translated_ar :$job->name_ar}}"
                                        autofocus>
                        ...
                        <div class="form-group col-md-12 mb-50">
                            ...
                            <div class="position-relative has-icon-left">
                                <input id="name_en"
                                        ...
                                        value="{{isset($translated_en) ? $translated_en :$job->name_en}}"
                                        autofocus>
                                <div class="form-control-position">
                                    <i class="bx bxs-lock"></i>
                                </div>
                        ...
                        <div class="d-flex justify-content-end mt-2rem">
                            <a href="{{route('jobs.index')}}" class="btn btn-light-secondary" data-dismiss="modal">
