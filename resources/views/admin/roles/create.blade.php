...
@section('title', trans('applang.create_role'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header modal-header bg-primary">
                    <h4 class="modal-title white">{{trans('applang.create_role')}}</h4>
                </div>
                <div class="card-body mt-1" style="padding-bottom: 13px">
                    <form action="{{route('roles.store')}}" method="POST">
                        @csrf

                        @livewire('admin.role-translation')

                        @if(request()->is(app()->getLocale().'/admin/roles/create/translated/*'))
                        ...
                        @livewire('admin.create-role-permissions', [
