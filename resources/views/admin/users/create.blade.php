...
@section('title', trans('applang.create_new_user'))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header modal-header bg-primary">
                    <h4 class="modal-title white">{{trans('applang.create_new_user')}}</h4>
                </div>
                <div class="card-body mt-1" style="padding-bottom: 13px">
                    <form action="{{route('users.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-50">
                                            ...
                                            <fieldset class="form-group">
                                                <select class="custom-select @error('gender') is-invalid @enderror" id="customSelect" name="gender">
                                                    ...
                                                    <option value="male">{{trans('applang.male')}}</option>
                                                    <option value="female">{{trans('applang.female')}}</option>
                                                </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <fieldset class="form-group">
                                        <select id="status" class="custom-select @error('status') is-invalid @enderror" name='status'>
                                            <option value="" selected disabled>{{trans('applang.select_status')}}</option>
                                            <option value="1">{{trans('applang.active')}}</option>
                                            <option value="2">{{trans('applang.close')}}</option>
                                            <option value="3">{{trans('applang.banned')}}</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <fieldset class="form-group">
                                        <select id="job_id" class="custom-select @error('job_id') is-invalid @enderror" name='job_id'>
                                            ...
                                            @foreach ($jobs as $job)
                                                <option value="{{$job->id}}">{{app()->getLocale() == 'ar' ? $job->name_ar : $job->name_en}}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div x-data="{ open: false }" class="system">
                            ...
                            <div x-show="open" id="roles_container">
