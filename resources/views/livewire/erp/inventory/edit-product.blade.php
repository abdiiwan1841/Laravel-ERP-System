<div class="card">
    <div class="card-header modal-header bg-primary">
        <h4 class="modal-title white">{{trans('applang.edit_product')}}</h4>
    </div>
                                ...
                                <fieldset class="form-group">
                                    <select id="unit_template_id" class="custom-select @error('unit_template_id') is-invalid @enderror" name='unit_template_id' wire:model="unit_template_id">
                                        ...
                                        @foreach($units_templates as $unit_template)
                                            <option value="{{$unit_template->id}}" {{$unit_template->id == $unit_template_id ? 'selected' : ''}}>
                                                {{app()->getLocale() == 'ar' ? $unit_template->template_name_ar : $unit_template->template_name_en}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <fieldset class="form-group">
                                    <select id="supplier_id" class="custom-select @error('supplier_id') is-invalid @enderror" name='supplier_id'>
                                        ...
                                        @foreach($suppliers as $supplier)
                                            <option value="{{$supplier->id}}" {{$supplier->id == $product->supplier_id ? 'selected' : ''}}>{{$supplier->commercial_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative has-icon-left mb-1">
                                    <input id="lowest_stock_alert"
                                           ...
                                           value="{{$product->lowest_stock_alert ?? old('lowest_stock_alert')}}"
                                           autofocus>
                                    <div class="form-control-position">
                                        <i class="bx bx-pen"></i>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset class="form-group mb-50">
                                    <select id="status" class="custom-select @error('status') is-invalid @enderror" name='status'>
                                        <option value="" disabled>{{trans('applang.status')}}</option>
                                ...
                                <fieldset class="form-group">
                                    <select id="measurement_unit_id" class="custom-select @error('measurement_unit_id') is-invalid @enderror" name='measurement_unit_id' wire:model="measurement_unit_id">
                                        ...
                                        @foreach($measurement_units as $measurement_unit)
                                            <option value="{{$measurement_unit->id}}" {{$measurement_unit->id == $product->measurement_unit_id ? 'selected' : ''}}>
                                                {{app()->getLocale() == 'ar' ? $measurement_unit->largest_unit_ar : $measurement_unit->largest_unit_en}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="position-relative has-icon-left mb-1">
                                    <input id="sell_price"
                                           ...
                                           value="{{$product->sell_price ?? old('sell_price')}}"
                                           autofocus
                                ...
                                <fieldset class="form-group">
                                    <select id="first_tax_id" class="custom-select @error('first_tax_id') is-invalid @enderror" name='first_tax_id'>
                                        ...
                                        @foreach($taxes as $tax)
                                            <option value="{{$tax->id}}" {{$tax->id == $product->first_tax_id ? 'selected' : ''}}>
                                                {{$tax->tax_name_ar}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset class="form-group">
                                    <select id="second_tax_id" class="custom-select @error('second_tax_id') is-invalid @enderror" name='second_tax_id'>
                                        ...
                                        @foreach($taxes as $tax)
                                            <option value="{{$tax->id}}" {{$tax->id == $product->second_tax_id ? 'selected' : ''}}>
                                                {{$tax->tax_name_ar}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative has-icon-left mb-1">
                                    <input id="lowest_sell_price"
                                           ...
                                           value="{{$product->lowest_sell_price ?? old('lowest_sell_price')}}"
                                           autofocus>
                                    <div class="form-control-position">
                                        <i class="bx bx-pen"></i>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative has-icon-left mb-1 input-group">
                                    <input id="profit_margin"
                                           ...
                                           value="{{$product->profit_margin ?? old('profit_margin')}}"
                                           autofocus>
                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset class="form-group">
                                    <select id="discount_type" class="custom-select @error('discount_type') is-invalid @enderror" name='discount_type'>
                                        ...
                                        <option value="1" {{$product->discount_type == '1' ? 'selected' : ''}}>{{trans('applang.percentage')}}</option>
                                        <option value="0" {{$product->discount_type == '0' ? 'selected' : ''}}>{{trans('applang.cash_amount')}}</option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex justify-content-start">
                                    <div class="position-relative has-icon-left w-100">
                                        <input type="text"
                                               class="form-control button-input @error('sku') is-invalid @enderror"
                                               name="sku"
                                               placeholder="{{trans('applang.generate_sku')}}"
                                               value="{{$product->sku}}"
                                    ...
                                    <div class="input-group-prepend generateSKU">
                                        <button class="btn btn-light-danger text-append-reset" wire:click.prevent="generateSKU({{$product->id}})">
                                    ...
                                    @if($product_barcode)
                                        <div class="mt-2 custom-card p-1 bg-white">
                                            <div class="d-flex justify-content-between mb-0">
                                                ...
                                                <h6 class="d-flex justify-content-center mb-0" style="font-size: 14px">
                                                    {{$product_sell_price}} {{$currency_symbol}}
                                                </h6>
                                            </div>
                        ...
                        <div class="form-row mb-50">
                            <div class="col-md-12 mb-50">
                                <div id='img_contain'>
                                    <img id="blah"
                                         align='middle'
                                         src="{{$product_image ? $product_image->temporaryUrl() : asset('uploads/products/images/'.$product->product_image)}}"
                                         alt="Product Image"
                                         title='Product Image'/>
                                </div>
