...
class CreateSalesInvoice extends Component
{
    ...
    public function mount()
    {
        ...
        //set invoice number
        $model = SalesInvoice::all();
        $model->sequential_code_id = SequentialCode::where('model', 'sales_invoices')->pluck('id')->first();
        $model->number = SalesInvoice::where('sequential_code_id', $model->sequential_code_id)->max('number')+1 ;
        $numbers_length =  SequentialCode::where('model', 'sales_invoices')->pluck('numbers_length')->first();
        ...
        $this->client_number = $model->number;
    ...
    public function showCreateClient()
    {
        ...
        $this->full_name = trans('applang.client') . ' #' .$this->client_number;
    }
...
//            $this->discount = '';
    ...
    {
        return view('livewire.erp.sales.sales-invoices.create-sales-invoice');
    }
}
